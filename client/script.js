...
// CODE HERE
let btn = document.querySelector("#say-hello-button");
...
btn.addEventListener("mouseout",unColor);
...
// CODE HERE
const query = () =>{
    axios.get('http://localhost:3000/query-test/? time=3pm/?name=tim').then(res =>{
        console.log(res.data);
    })
}
